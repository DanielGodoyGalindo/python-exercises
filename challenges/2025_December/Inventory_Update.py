...
4. update_inventory([[0, "Bowling Ball"], [0, "Dirty Socks"], [0, "Hair Pin"], [0, "Microphone"]], [[1, "Hair Pin"], [1, "Half-Eaten Apple"], [1, "Bowling Ball"], [1, "Toothpaste"]])
...
def update_inventory(inventory, shipment):
    ...
    for qty, item in inventory:
        result.append([inventory_dict[item], item])
